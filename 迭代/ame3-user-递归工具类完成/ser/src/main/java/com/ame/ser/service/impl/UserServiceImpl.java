...
import com.ame.ser.utils.Md5Util;
...
// =================================================================================================================
     ...
     */
    @Override
    public void createUser(User user) throws TableFieldContentDuplicateException {
        ...
        if (result == null){
            ...
            defaultPassword=Md5Util.pwdByMd5(defaultPassword, user.getUserName(), 5);
